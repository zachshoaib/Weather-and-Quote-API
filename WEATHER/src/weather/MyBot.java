...
public class MyBot extends PircBot {
	...
	{
    	//if second word is a number then use zipcode api
    	...
    	//if the user input does not contain numbers it is a city that has been entered 
    	else
    	{
    		//unique api key
